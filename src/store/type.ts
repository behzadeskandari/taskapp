...
interface UnsetTaskToDelteAction {
...
export type ListAction = AddListAction | GetListsACtion | GetListByIdAction | SetListIdToDeleteAction | SetListToEditAction | SetListToEditAction |
    DeleteListAction | UpdateListAction | SetSelectedListAction | AddTaskAction | DeleteTaskAction | SetTaskToDeleteAction | UnsetTaskToDelteAction | EditTaskAction | SetTaskToEditAction | UnsetTaskToEditAction | TaskToEditAction;
